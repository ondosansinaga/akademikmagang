...
define("SITE_NAME", "AkademikMagang");
...
define("APP_ID", "56af32142d96c37c2ebdd7e6c1ada297");
...
define("DB_PASSWORD", "");
define("DB_NAME", "db_akademikmagang");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_akun'] : null ));
