                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-nama_dospem">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-sourceurl="<?php print_link('api/json/daftar_magang_nama_dospem_option_list'); ?>" 
                                                data-source='<?php print_link('api/json/daftar_magang_nama_dospem_option_list'); ?>' 
                                                data-value="<?php echo $data['nama_dospem']; ?>" 
                                                data-pk="<?php echo $data['id_daftarmagang'] ?>" 
                                                data-url="<?php print_link("daftar_magang/editfield/" . urlencode($data['id_daftarmagang'])); ?>" 
                                                data-name="nama_dospem" 
