...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Status Mahasiswa Magang</h4>
                </div>
                <div class="col-sm-4 ">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="bg-light animated fadeIn page-content">
                            <div id="daftar_magang-status_mahasiswa_magang-records">
                                    ...
                                    <table class="table  table-striped text-left table-bordered">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-posisi"> Posisi</th>
                                                <th  class="td-sertifikat_terima"> Sertifikat Terima</th>
