...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Laporan Akhir</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("laporan_akhir/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-id_akun"  value="<?php  echo $data['id_akun']; ?>" type="hidden" placeholder="Enter Id Akun"  required="" name="id_akun"  class="form-control " />
                                    <input id="ctrl-id_dospem"  value="<?php  echo $data['id_dospem']; ?>" type="hidden" placeholder="Enter Id Dospem"  required="" name="id_dospem"  class="form-control " />
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-nama_dospem"  value="<?php  echo $data['nama_dospem']; ?>" type="text" placeholder="Enter Nama Dospem"  readonly required="" name="nama_dospem"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="catatan_dospem">Catatan Dospem <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <textarea placeholder="Enter Catatan Dospem" id="ctrl-catatan_dospem"  required="" rows="5" name="catatan_dospem" class=" form-control"><?php  echo $data['catatan_dospem']; ?></textarea>
                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input id="ctrl-username_dospem"  value="<?php  echo $data['username_dospem']; ?>" type="hidden" placeholder="Enter Username Dospem" list="username_dospem_list"  required="" name="username_dospem"  class="form-control " />
