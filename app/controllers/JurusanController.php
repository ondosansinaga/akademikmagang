...
class JurusanController extends SecureController{
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("jurusan.id_jurusan", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_jurusan");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_jurusan","nama_jurusan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_jurusan' => 'required',
