...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'akun' => array('list','view','userregister','accountedit','accountview','add','edit', 'editfield','delete','import_data'),
							'daftar_magang' => array('view','add','edit', 'editfield','delete','import_data','status_mahasiswa_magang','mahasiswa_magang_aktif','mahasis_telah_selesai'),
							'jurusan' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'laporan_akhir' => array('view','add','edit', 'editfield','delete','import_data'),
							'review' => array('view','edit', 'editfield','delete','import_data'),
							'sertifikat' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'dospem' => array('list','view','add','edit', 'editfield','delete')
						),
		
			'mahasiswa' =>
						array(
							'akun' => array('view'),
							'daftar_magang' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'laporan_akhir' => array('list','view','add','edit', 'editfield','import_data'),
							'review' => array('view','add','import_data','review_mahasiswa'),
							'sertifikat' => array('view','sertifikat_mahasiswa')
						),
		
			'dosen pembimbing' =>
						array(
							'akun' => array('accountedit','accountview'),
							'daftar_magang' => array('bimbingan'),
							'laporan_akhir' => array('view','edit', 'editfield','delete','import_data','laporan_akhir_dospem'),
							'review' => array('list','view','edit', 'editfield','delete','import_data')
						)
		);
